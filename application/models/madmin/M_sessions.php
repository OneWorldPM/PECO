...
class M_sessions extends CI_Model {
    ...
    function createSessions() {
        ...
        $set = array(
            ...
            'us_emea_switch' => trim($post['us_emea_switch']),
            'sessions_date_display_us_emea' => date("Y-m-d", strtotime($post['sessions_date_display_us_emea'])),
            'start_time_display_us_emea' => date("H:i", strtotime($post['start_time_display_us_emea'])),
            'end_time_display_us_emea' => date("H:i", strtotime($post['end_time_display_us_emea'])),
            'apj_switch' => trim($post['apj_switch']),
            'sessions_date_display_apj' => date("Y-m-d", strtotime($post['sessions_date_display_apj'])),
            'start_time_display_apj' => date("H:i", strtotime($post['start_time_display_apj'])),
            'end_time_display_apj' => date("H:i", strtotime($post['end_time_display_apj'])),
            ...
            'session_reply' => trim($post['session_reply']),
            'reply_video_id' => trim($post['reply_video_id']),
