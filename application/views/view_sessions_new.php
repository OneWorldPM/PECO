...
<script src="<?= base_url() ?>front_assets/js/adapter-latest.js"></script>
...
<script>
    ...
    let streamName = "<?=$sessions->embed_html_code?>";
    console.log('Millicast Viewer Stream: ', streamName);

    //Millicast required info.
    let url = "<?=$millicast_config->data->wsUrl?>";;// path to Millicast Server - Returned from API
    let jwt = "<?=$millicast_config->data->jwt?>";//authorization token - Returned from API
