...
<div class="limiter">
    <div class="container-login100" style="background-image: url(<?=base_url()?>front_assets/agility/Agility_main_page_backdrop.png)">
        <div class="wrap-login100">
            <div class="login100-form-title" style="background-color: #ececec;position: unset">
					<img src="<?= base_url() ?>front_assets/peco/IAMPECO.png" style="width: 50%;height: auto;background-color: #ececec;margin-top: 8px;margin-bottom: 8px;">
            </div>
...
<!--                </div>-->
                ...
                <small style="color: red;">case sensitive</small>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="afterOtp" style="display: none">
                    ...
                    <div id="divOuter">
                        <div id="divInner">
                            <input class="partitioned" id="otpInput" type="text" maxlength="4" />
                        </div>
                    </div>

                    <div style="margin-top: 15px;">
                        <p>
                            <input type="checkbox" id="trust_browser_check2"> Trust this browser!
                        </p>
...
<!--                        <option data-countryCode="CA" value="1">Canada (+1)</option>-->
                ...
                <div id="afterOtpAddMob" style="display: none;">
                    ...
                    <div id="divOuter">
                        <div id="divInner">
                            <input class="partitioned" id="addMobileOtpInput" type="text" maxlength="4" />
                        </div>
                    </div>

                    <div style="margin-top: 15px;">
                        <p>
                            <input type="checkbox" id="trust_browser_check1"> Trust this browser!
                        </p>
                        <button class="verify-browser-btn btn btn-sm btn-success m-t-5" action="add-mobile"><i class="fa fa-check" aria-hidden="true"></i> Verify</button>
                    </div>
