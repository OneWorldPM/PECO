                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <small><i class="fa fa-calendar" aria-hidden="true"></i>
                                                <span style="color: #b97a43;"><?= $sessions->sessions_date . ' ' . date("h:i A", strtotime($sessions->time_slot))?> - <?=date("h:i A", strtotime($sessions->end_time)) ?> ET</span>
                                                <?php
            ...
            if ($('#timer_status').val() == 1)
            {
                ...
                if (session_type_id == 16 && zoom_redirect == 1)
                {
                    ...
                    if (window.open(zoom_redirect_url, "_blank")){
                        ...
                        $('#timerPara').html('' +
                            '<span><a id="unableToOpenZoom" href="'+zoom_redirect_url+'" target="_blank">Your browser has blocked the opening of the new tab for Webinar, please click here to open Webinar.</a></span>');
                    }
                }else{
                    $('#timer_status').val(0)
                    window.location = "<?= site_url() ?>sessions/view/<?= (isset($sessions) && !empty($sessions)) ? $sessions->sessions_id : "" ?>";
